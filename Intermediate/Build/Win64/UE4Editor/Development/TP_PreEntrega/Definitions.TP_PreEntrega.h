...
#define UE_PROJECT_NAME TP_PreEntrega
#define UE_TARGET_NAME TP_PreEntregaEditor
#define UE_MODULE_NAME "TP_PreEntrega"
...
#define TP_PREENTREGA_API DLLEXPORT
